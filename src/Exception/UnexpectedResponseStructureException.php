...
class UnexpectedResponseStructureException extends \RuntimeException {
    ...
    protected function makeMessage($httpMethod, $restMethodPath, $response = null) {
        ...
        $message = 'Unexpected structure of NationBuilder API response for ' . $httpMethod . ' /' . $restMethodPath . '/: ' . $code . $details;
        return $message;
    }
}
